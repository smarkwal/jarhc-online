...
public class ApiStack extends AbstractStack {
	...
	public ApiStack(
		...
		IFunction jarhcCheckFunction = Function.Builder.create(this, "JarhcCheckFunction")
				...
				.code(Code.fromAsset("../sam-api/jarhc-check/build/distributions/jarhc-check-1.0.0-SNAPSHOT.zip"))
		...
		AssetImageCode japiccCheckDockerImage = AssetImageCode.Builder.create("../sam-api/japicc-check")
				.build();
		...
		IFunction restApiFunction = Function.Builder.create(this, "RestApiFunction")
				...
				.code(Code.fromAsset("../sam-api/rest-api/build/distributions/rest-api-1.0.0-SNAPSHOT.zip"))
