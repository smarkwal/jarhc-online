...
class ApiStack extends Stack {
	...
	public ApiStack(final Construct scope, final String id, final StackProps props,
		...
		websiteBucketName = Optional.ofNullable(websiteBucketName).isPresent() ? websiteBucketName : "online.jarhc.org";
		websiteUrl = Optional.ofNullable(websiteUrl).isPresent() ? websiteUrl : "https://online.jarhc.org";
		cognitoUserPoolArn = Optional.ofNullable(cognitoUserPoolArn).isPresent() ? cognitoUserPoolArn : "arn:aws:cognito-idp:eu-central-1:837783538267:userpool/eu-central-1_duUV8DgO7";
		websiteBucketUrl = Optional.ofNullable(websiteBucketUrl).isPresent() ? websiteBucketUrl : "https://online.jarhc.org";
		apiDomain = Optional.ofNullable(apiDomain).isPresent() ? apiDomain : "api.jarhc.org";
		...
		japiccCheckFunction.addMetadata("DockerContext", "/Users/markwalder/Documents/Private/IntelliJ/jarhc-online/sam-api/japicc-check"); // TODO: fix
		...
		japiccCheckFunctionEventInvokeConfig.addMetadata("DockerContext", "/Users/markwalder/Documents/Private/IntelliJ/jarhc-online/sam-api/japicc-check"); // TODO: fix
		...
		CfnRestApi restApi = CfnRestApi.Builder.create(this, "RestApi")
				.body(
						Map.of(
										...
										"/japicc/submit", Map.of(
												...
												"options", Map.of(
														...
														"responses", Map.of(
																"200", Map.of(
																		"headers", Map.of(
																				"Access-Control-Allow-Origin", Map.of("type", "string"),
								...
								"x-amazon-apigateway-gateway-responses", Map.of(
										"DEFAULT_5XX", Map.of(
												"responseParameters", Map.of(
								...
								"securityDefinitions", Map.of(
										"CognitoAuthorizer", Map.of(
												"in", "header",
												"type", "apiKey",
												"name", "Authorization",
												"x-amazon-apigateway-authorizer", Map.of(
														"providerARNs", List.of("arn:aws:cognito-idp:eu-central-1:837783538267:userpool/eu-central-1_duUV8DgO7"),
								...
								"definitions", Map.of(
										"jarhcsubmitmodel", Map.of(
												"additionalProperties", false,
												"required", List.of("classpath"),
												"type", "object",
												"properties", Map.of(
														"provided", Map.of(
																"items", Map.of(
										...
										"mavensearchmodel", Map.of(
												"additionalProperties", false,
												"required", List.of("coordinates"),
												"type", "object",
												"properties", Map.of(
														"coordinates", Map.of(
																"type", "string"
										...
										"japiccsubmitmodel", Map.of(
												"additionalProperties", false,
												"required", List.of("oldVersion", "newVersion"),
												"type", "object",
												"properties", Map.of(
														"newVersion", Map.of("type", "string"),
														"oldVersion", Map.of("type", "string")
												)
										)
								),
								"swagger", "2.0",
								"x-amazon-apigateway-request-validators", Map.of(
										"body-only", Map.of(
